...
#Boolean - No possibility of making a mistake of having the wrong precision, it's always either yes or no (Pure logic statement)
...
print(type(alpha_list)) 		#will say tuple, a data structure that stores an ordered sequence of values
print(type(alpha_list[0])) 		#will say string, any series of characters
